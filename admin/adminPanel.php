...
<body>
	<div id ="wrapper">
		<div class ="header">
			<div class = "title"><h2><a href="#">Polytechnic University of the Philippines</a></h2>
			<h3><a>Republic of the Phillippines</h3></a>
			<img src="img/PUPLogo.png"width="90px" height="88px">
			</div>
		</div>
		...
		<div class = "content">
			<div class = "sidenav hidden-print">
				...
				<div><a href="adminPanel.php?tab=viewCategories" class="nav"><span class="glyphicon glyphicon-th-list"></span>&nbsp;Subjects</a></div>
	...
	function loadOption()
	{
		...
		switch(currentTab)
		{
			...
			case 'filter':
					...
					var mySite = "top.php?to=" + to + "&from=" + from + "&group=" + group;
					$("#options").load(mySite);
				break;
